...
export default function ArticleCard({ article, categories }: Props) {
  ...
  return (
    <Link to={`/articles/${article.slug}`} className="group block bg-white rounded-xl overflow-hidden shadow hover:shadow-lg transition-shadow duration-200">
      ...
      <div className="p-4">
        ...
        <h3 className="font-bold text-gray-900 line-clamp-2 leading-snug mb-1 group-hover:text-indigo-600 transition-colors">
          {article.title}
        </h3>
